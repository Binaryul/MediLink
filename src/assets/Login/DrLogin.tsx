...
interface DrLoginProps {
  activeTab: string; // will check what the active tab is currently
}

function DrLogin({ activeTab }: DrLoginProps) {
  ...
  return (
    <div className={styles.loginForm}>
      ...
      <div className={styles.passwordContainer}>
        <input
          type={passwordVisible ? "text" : "password"} //changes type {text or password} depending on passwordVisible atribute
